...
function AddressForm({ setviewFlag, setAddressChange, addressChange, firstname, lastname, allAddresses }) {
    ...
    return (
        <div className='jumbotron'>
            <form role='form' onSubmit={allAddresses.length === 0 ? onSubmitNewForm : onSubmitUpdatedForm}
